...
Public Class Question13
    Inherits Question
    Public Sub New()
        Me.Name = "13) Large sum"
        Me.Text = "Work out the first ten digits of the sum of the following one-hundred 50-digit numbers.

<See Code for numbers>
"
    End Sub
    Public Function Execute()
        Dim strAnswer As Double, runstart As DateTime = Now(), elapsed As TimeSpan

        Dim strDigits As String = "37107287533902102798797998220837590246510135740250\" &
        ...
        Dim arrDigits As Array = Split(strDigits, "\")
        Dim dblAnswer As Double = 0
        For Each n In arrDigits
            dblAnswer += n
        Next

        strAnswer = Left(Replace(dblAnswer.ToString, ".", ""), 10)

        elapsed = Now.Subtract(runstart)
        Return strAnswer.ToString() + " - Runtime: " + elapsed.TotalSeconds.ToString("0.00000")
    End Function
End Class
...
Public Class Question14
    Inherits Question
    Public Sub New()
        Me.Name = "14) Longest Collatz sequence"
        Me.Text = "The following iterative sequence is defined for the set of positive integers:
...
NOTE: Once the chain starts the terms are allowed to go above one million."
    ...
    Public Function Execute()
        ...
        Dim ChainCount As Long = 0, tempChainCount As Long = 0, n As Long = 0
        For i = CLng("500,000") To CLng("1,000,000")
            n = i : tempChainCount = 0
            Do While n <> 1
                If n Mod 2 = 0 Then
                    tempChainCount += 1
                    n = n / 2
                ...
                End If
            Loop
            If tempChainCount > ChainCount Then
